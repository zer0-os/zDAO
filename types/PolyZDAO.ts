...
export interface PolyZDAOInterface extends utils.Interface {
  ...
  functions: {
    ...
    "__ZDAO_init(address,address,uint256,address,bool,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [string, string, BigNumberish, string, boolean, BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface PolyZDAO extends BaseContract {
  ...
  functions: {
    ...
    zDAOInfo(
      ...
      [BigNumber, string, boolean, BigNumber, BigNumber, boolean] & {
        zDAOId: BigNumber;
        mappedToken: string;
