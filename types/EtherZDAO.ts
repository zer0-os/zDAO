...
export interface EtherZDAOInterface extends utils.Interface {
  ...
  functions: {
    ...
    "__ZDAO_init(address,uint256,address,(string,address,address,uint256,uint256,bool,uint256))": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "rootTunnel", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "setDestroyed",
    data: BytesLike
  ): Result;
...
export interface EtherZDAO extends BaseContract {
  ...
  functions: {
    ...
    rootTunnel(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    rootTunnel(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    rootTunnel(overrides?: CallOverrides): Promise<PopulatedTransaction>;
