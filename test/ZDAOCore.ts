...
//     const ZDAOCoreFactory: ZDAOCore__factory = await ethers.getContractFactory(
//       "ZDAOCore"
//     );
...
//     const ZDAOCoreProxyFactory: ZDAOCoreProxy__factory =
//       await ethers.getContractFactory("ZDAOCoreProxy");

//     const proxy = await ZDAOCoreProxyFactory.deploy(
//       ZDAOCore.address,
//       process.env.PROXY_ADMIN
//     );
...
//     // deploy Test ZNS Hub
//     const ZNSHubFactory: ZNSHubTest__factory = await ethers.getContractFactory(
//       "ZNSHubTest"
//     );
...
//       await expect(zDAOCoreProxyCast.addNewDAO(1, gnosisSafe1)).to.revertedWith(
//         "Already added"
//       );
//     });
//   });
...
//       await expect(
//         zDAOCoreProxyCast.connect(user1).addZNAAssociation(5, 2)
//       ).to.revertedWith("Invalid daoId");
//       await expect(
//         zDAOCoreProxyCast.connect(user1).addZNAAssociation(2, 2)
//       ).to.revertedWith("Not zNA owner");

//       await expect(
//         zDAOCoreProxyCast.connect(user2).addZNAAssociation(2, 2)
...
//     it("reverts", async function () {
//       await expect(
//         zDAOCoreProxyCast.connect(user1).removeZNAAssociation(5, 2)
//       ).to.revertedWith("Invalid daoId");
//       await expect(
//         zDAOCoreProxyCast.connect(user1).removeZNAAssociation(2, 2)
//       ).to.revertedWith("Not zNA owner");

//       await expect(
//         zDAOCoreProxyCast.connect(user2).removeZNAAssociation(2, 2)
//       ).to.revertedWith("Not associated yet");
//     });
//   });
// });
